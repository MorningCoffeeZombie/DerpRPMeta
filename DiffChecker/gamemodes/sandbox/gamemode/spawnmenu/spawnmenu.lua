...
-- MorningCoffeeZombie adding a function to hide unused tabs from players without correct perms
local function removeOldTables()
     if LocalPlayer():IsSuperAdmin() then return end
	
	--customCheck = function(ply) return CLIENT or
    --    table.HasValue({"superadmin", "owner", "coowner", "dio"}, ply:GetNWString("usergroup"))
    --end,
