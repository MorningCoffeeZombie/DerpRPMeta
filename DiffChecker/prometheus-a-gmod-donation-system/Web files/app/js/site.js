$(function(){
    ...
    tinymce.init({
        ...
        plugins: 'paste textcolor colorpicker advlist autolink link image imagetools lists charmap print preview autoresize wordcount contextmenu searchreplace directionality textpattern table media directionality insertdatetime',
        toolbar: 'undo redo | styleselect | forecolor backcolor bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image | media | table | searchreplace | insertdatetime | ltr rtl',
