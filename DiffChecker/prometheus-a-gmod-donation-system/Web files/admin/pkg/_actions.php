            ...
            <div class="checkbox">
                ...
                <div class="options"
                    ...
                    <div class="customjob_weapons"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <i class="fas fa-plus fa-2x" style="color: darkgreen; cursor:pointer; margin-top: 10px"
                                   id="addWeapon"></i>
                            </div>
                        </div>
                        ...
                        <script type="text/javascript">
                            $('#addWeapon').on('click', function () {
                                ...
                                var value = '<div class="weapon">' +
                                    ...
                                    '</div>' +
                                    '<div class="col-md-1">' +
                                    '<i class="fas fa-minus-circle fa-fw delWeapon" style="color: #c10000; cursor:pointer; padding-top: 14px;"></i>' +
                                    '</div>' +
                                    '</div>';
                    ...
                    <div class="customjob_models"
                        ...
                        <div class="row">
                            <div class="col-12 col-md-12">
                                <i class="fas fa-plus fa-2x fa-fw" style="color: darkgreen; cursor:pointer; margin-top: 10px"
                                   id="addModel"></i>
                            </div>
                        </div>
                        ...
                        <script type="text/javascript">
                            $('#addModel').on('click', function () {
                                ...
                                var value = '<div class="model">' +
                                    ...
                                    '</div>' +
                                    '<div class="col-md-1">' +
                                    '<i class="fas fa-minus-circle fa-fw delModel" style="color: #c10000; cursor:pointer; padding-top: 14px;"></i>' +
                                    '</div>' +
                                    '</div>';
