if EdgeHUD.Configuration.GetConfigValue( "TopLeft" ) then
	...
	salaryWidget:SetPos(VARS.ScreenMargin,VARS.ScreenMargin)
	...
	moneyWidget:SetPos(VARS.ScreenMargin + VARS.ElementsMargin + VARS.salaryWidgetWidth,VARS.ScreenMargin)
	...
	if EdgeHUD.Configuration.GetConfigValue( "VoteHUD" ) then
		...
		timer.Create("EdgeHUD:LoadVoteHUD",0.5,60,function(  )
			...
			queueWidget:SetPos(VARS.ScreenMargin, VARS.ScreenMargin + VARS.WidgetHeight + VARS.ElementsMargin * 2 + VARS.voteWindowHeight)
			...
			local function startVote( id, question, time, isVote )
				...
				window:SetPos(VARS.ScreenMargin, VARS.ScreenMargin + VARS.WidgetHeight + VARS.ElementsMargin)
