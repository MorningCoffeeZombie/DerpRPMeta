...
EdgeHUD.AddPhrase(LANG,"IDENTITY", "Identitée")
...
EdgeHUD.AddPhrase(LANG,"PROPLIMIT","%P entitée")
...
EdgeHUD.AddPhrase(LANG,"VOTE_PENDING","Tu as une nouveau vote/question en attente. Enlève ton tool gun de t'es main pour votée.")
...
EdgeHUD.AddPhrase(LANG,"TOPRIGHT_LOCKDOWN","Un couvre-feu est en cours, veuilliez vous abriter !")

EdgeHUD.AddPhrase(LANG,"TOPRIGHT_WANTED_TITLE","RECHERCHEE")
EdgeHUD.AddPhrase(LANG,"TOPRIGHT_WANTED","Tu es recherché(e) ! La police te recherche !")

EdgeHUD.AddPhrase(LANG,"TOPRIGHT_ARRESTED_TITLE","ARRÊTE(E)")
...
EdgeHUD.AddPhrase(LANG,"ARRESTED", "ARRÊTE(E)")
...
EdgeHUD.AddPhrase(LANG,"WANTED", "RECHERCHE(E)")
...
EdgeHUD.AddPhrase(LANG,"UNWANTED", "PLUS RECHERCHE(E)")
...
--TAGS: %S = Suspect Name
EdgeHUD.AddPhrase(LANG,"WARRANTED_COP", "Tu es maintenant autorisé(e) a rechercher le domicile de %S")
...
EdgeHUD.AddPhrase(LANG,"UNWARRANTED_SUSPECT", "Le mandat de %S a expiré.")
...
EdgeHUD.AddPhrase(LANG,"LOCKDOWN_INITIATED", "Le maire a initialisé un couvre-feu, Met toi a l'abri !")
...
EdgeHUD.AddPhrase(LANG,"VEHICLE_DMG_EXHAUST", "[Véhicule] : Dommages d'échappement détectés, Répare immédiatement le véhicule pour éviter d'endommager le moteur.")
...
EdgeHUD.AddPhrase(LANG,"ADMINTELL_TITLE", "AVIS D'ADMIN")
