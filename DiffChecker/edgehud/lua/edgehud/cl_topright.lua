if EdgeHUD.Configuration.GetConfigValue( "TopRight" ) then
	...
	agendaPanel:SetPos(screenWidth - VARS.ScreenMargin - VARS.toprightWidth, VARS.ScreenMargin)
	...
	for i = 1,#detailWidgets do
		...
		Widget:SetPos(screenWidth - VARS.ScreenMargin - VARS.toprightWidth, VARS.detailsPos)
	...
	timer.Create("EdgeHUD:UpdateTopRight",1,0,function(  )
		...
		for i = 1,#detailWidgetPanels do
			...
			curWidget:SetPos(screenWidth - VARS.ScreenMargin - VARS.toprightWidth, detailsPos)
