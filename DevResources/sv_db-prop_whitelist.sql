/*
SQLITE HAS A LIMIT OF 500 INSERTS PER STATEMENT
https://www.eversql.com/sql-syntax-check-validator/

*/

--SELECT COUNT(*) FROM FPP_BLOCKEDMODELS1
--SELECT * FROM FPP_BLOCKEDMODELS1
--DELETE FROM FPP_BLOCKEDMODELS1	-- THIS WILL DELETE ALL DATA IN TABLE!!!





INSERT INTO FPP_BLOCKEDMODELS1(model) VALUES 
...
-- This group is the existing whitelist (taken directrly from server)
-- The only difference is pre-existing props from the above lists were removed (unique insert errors) list created via VLookUp
INSERT INTO FPP_BLOCKEDMODELS1(model) VALUES 
("models\props/cs_militia/militiawindow02_breakable.mdl"),
("models\props/cs_militia/wndw01.mdl"),
...
("models/bluesdoubleornothing/slots_1.mdl"),
("models/dav0r/camera.mdl"),
("models/zerochain/props_weedfarm/zwf_autopacker.mdl"),
("models/zerochain/props_weedfarm/zwf_backmix.mdl"),
